...
public class RightHatchOne extends MotionCommandGroup
{

  public RightHatchOne()
  {
    addSequential(new AutonDrivePath("RightHatchOne.json", true));
    addMotionProfile("RightHatchOne.json");
